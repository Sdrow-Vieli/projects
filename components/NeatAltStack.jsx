...
import SideModalNeatAltStack from "./SideModalNeatAltStack";
...
const StackPair = ({
  ...
  const [modalFigmaOpen, setModalFigmaOpen] = useState(false);
      ...
      >
        {selectedPair && (
          <SideModalNeatAltStack
            ...
            onOpenFigma={() => setModalFigmaOpen(true)}
          />
        )}

        <FigmaEmbedModal
          open={modalFigmaOpen}
          onClose={() => setModalFigmaOpen(false)}
        />
      </SideModal>
    </>
  );
